...
| kjdkd/Rhin-Kanu | D:\WEB_PROJECTS\Rhin-Kanu | True | True | https://github.com/kjdkd/Rhin-Kanu.git | main | 0 0 | False | CLEAN_SYNCED | Clean worktree and in sync with origin/main |
| kjdkd/WEBSITE-PLANUNG | D:\WEB_PROJECTS\WEBSITE-PLANUNG | True | True | https://github.com/kjdkd/WEBSITE-PLANUNG.git | main | 0 0 | False | CLEAN_SYNCED | Clean worktree and in sync with origin/main |

## Commit Decisions
- INFOS_COMMIT_BLOCKED_RISK_FILES=false
- TRADING_ZENTRALE_COMMIT_SKIPPED=true (mixed code/docs changes with unknown risk)
- RHIN_KANU_COMMIT_SKIPPED=false
